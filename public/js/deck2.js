...
var counter=0;
for(var i=0;i<10;i++){
    document.write('<img id = "' + i + 's" class = "draggable" height = 246 width = 175 back="images/creativeimages/g'+ i +'.jpg" style="top:' + (t+counter) + 'px; left:' + (l+counter) + 'px;" src="images/back.jpg">');
